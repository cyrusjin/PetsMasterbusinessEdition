...
const articles = [
  ...
  },
  {
    ...
    category: 'order',
    title: '怎么修改订单价格？',
    summary: '服务前改价给订单用，完成后可改结算价格方便记账。',
    steps: [
      '待确认、待开始和服务中，在列表或详情点「修改价格」。',
      '已完成订单点「修改结算价格」，只改商家记账金额，不会通知宠主。',
      '按实际调整各项费用后保存。在线已付款订单需先退款再改价。'
    ],
    action: 'orders',
    actionLabel: '查看订单'
  },
  ...
  },
  {
    ...
    steps: [
      ...
      '员工只能查看会员状态。试用或会员到期后，可先去签到领回 1 天，或续费后继续使用商家经营功能。'
    ],
    action: 'membership',
    actionLabel: '打开会员'
  },
  {
    id: 'daily-check-in',
    category: 'open',
    title: '会员到期了，怎么靠签到领回使用权？',
    summary: '每天签到得 1 天会员，连续 21 天再送 1 个月。',
    steps: [
      '底部「签到」每天可领取 1 天会员，奖励直接加到当前门店。',
      '连续签到 21 天，第 21 天额外再送 1 个月会员。中断后从第 1 天重新累计。',
      '即使会员刚到期，也可以进入签到页领回 1 天，避免经营入口被锁死。'
    ],
    action: 'checkIn',
    actionLabel: '去签到'
  },
